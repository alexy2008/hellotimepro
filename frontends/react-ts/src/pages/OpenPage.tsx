    ...
    <main className="cy-container">
      <div className="cy-open-center">
        ...
        <div style={{ display: "flex", gap: "var(--space-3)", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <button className="cy-btn cy-btn--ghost cy-btn--lg" onClick={paste}>
            粘贴识别
          </button>
        </div>

        <div style={{ marginTop: "var(--space-10)", color: "var(--color-text-muted)", fontSize: "var(--font-size-sm)" }}>
          <div style={{ display: "flex", gap: "var(--space-4)", justifyContent: "center", flexWrap: "wrap" }}>
            <span>💡 可用 <code style={{ background: "var(--color-surface-2)", padding: "2px 6px", borderRadius: "var(--radius-sm)" }}>/c/&lt;code&gt;</code> 直链访问</span>
