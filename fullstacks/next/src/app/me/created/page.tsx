...
export default function MeCreatedPage() {
  const mine = useCapsuleStore((s) => s.mine);
  const fetchMine = useCapsuleStore((s) => s.fetchMine);
  ...
  return (
    <>
      ...
      <div className="cy-toolbar" style={{ borderBottom: "none", paddingTop: 0 }}>
        ...
        <Link className="cy-btn cy-btn--primary cy-btn--sm" href="/create">
          + 新建胶囊
        </Link>
      </div>
